...
AmCharts.ValueAxis = AmCharts.Class({
  ...
  draw: function () {
    ...
    if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
      ...
      this.exponential = !1;
      for (f = p; f < q; f += n)
        t = AmCharts.roundTo(this.step * f + this.min, s), -1 != String(t).indexOf('e') && (this.exponential = !0, String(t).split('e'));
        ...
        if (p = s * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
          if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
            ...
            if (p == this.baseValue && 'radar' != a.type) {
              var D, H, x = this.viW, B = this.viH;
              v = this.viX;
              u = this.viY;
              'H' == this.orientation ? 0 <= e && e <= x + 1 && (D = [
                e,
                e,
                e + g
              ], H = [
              ...
              D && (e = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), e = AmCharts.line(a.container, D, H, this.gridColor, e, 1, this.dashLength), e.translate(v, u), this.grid0 = e, a.axesSet.push(e), e.toBack());
            }
...
AmCharts.RecItem = AmCharts.Class({
  construct: function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    this.set = s;
    var w = a.axisThickness, v = a.axisColor, t = a.axisAlpha, u = a.tickLength, x = a.gridAlpha, F = a.gridThickness, B = a.gridColor, z = a.dashLength, I = a.fillColor, D = a.fillAlpha, H = a.labelsEnabled;
    m = a.labelRotation;
    ...
    if ('H' == Na) {
      if (0 <= b && b <= X + 1 && (0 < u && 0 < t && b + k <= X + 1 && ($ = AmCharts.line(r, [
          b + k,
          b + k
        ], [
          0,
          u
        ], v, t, F), s.push($)), 0 < x && (W = AmCharts.line(r, [
          b,
          b + aa,
          b + aa
        ], [
          ...
          Q + ga,
          ga
        ], B, x, F, z), s.push(W))), A = 0, G = b, g && 90 == m && T && (G -= p), !1 === d ? (W = 'start', A = 'bottom' == ma ? T ? A + u : A - u : T ? A - u : A + u, G += 3, e && (G += e / 2 - 3, W = 'middle'), 0 < m && (W = 'middle')) : W = 'middle', 1 == V && 0 < D && !g && !l && ba < X && (d = AmCharts.fitToBounds(b, 0, X), ba = AmCharts.fitToBounds(ba, 0, X), ja = d - ba, 0 < ja && (fill = AmCharts.rect(r, ja, a.height, I, D), fill.translate(d - ja + aa, ga), s.push(fill))), 'bottom' == ma ? (A += Q + p / 2 + na, T ? (0 < m ? (A = Q - S / 2 * Math.sin(Y) - u - 3, G += S / 2 * Math.cos(Y) - 4 + 2) : 0 > m ? (A = Q + S * Math.sin(Y) - u - 3 + 2, G += -S * Math.cos(Y) - y * Math.sin(Y) - 4) : A -= u + p + 3 + 3, A -= fa) : (0 < m ? (A = Q + S / 2 * Math.sin(Y) + u + 3, G -= S / 2 * Math.cos(Y)) : 0 > m ? (A = Q + u + 3 - S / 2 * Math.sin(Y) + 2, G += S / 2 * Math.cos(Y)) : A += u + w + 3 + 3, A += fa)) : (A += ga + p / 2 - na, G += aa, T ? (0 < m ? (A = S / 2 * Math.sin(Y) + u + 3, G -= S / 2 * Math.cos(Y)) : A += u + 3, A += fa) : (0 < m ? (A = -(S / 2) * Math.sin(Y) - u - 6, G += S / 2 * Math.cos(Y)) : A -= u + p + 3 + w + 3, A -= fa)), 'bottom' == ma ? ja = (T ? Q - u - 1 : Q + w - 1) + na : (ka = aa, ja = (T ? ga : ga - u - w + 1) - na), f && (G += f), f = G, 0 < m && (f += S / 2 * Math.cos(Y)), Z && (p = 0, T && (p = S / 2 * Math.cos(Y)), f + p > X + 2 || 0 > f))
        Z.remove(), Z = null;
    } else {
      0 <= b && b <= Q + 1 && (0 < u && 0 < t && b + k <= Q + 1 && ($ = AmCharts.line(r, [
        0,
        u
      ], [
        b + k,
      ...
      if (!0 === T && 'left' == ma || !1 === T && 'right' == ma)
        W = 'start';
      A = b - p / 2;
      1 == V && 0 < D && !g && !l && (d = AmCharts.fitToBounds(b, 0, Q), ba = AmCharts.fitToBounds(ba, 0, Q), Y = d - ba, fill = AmCharts.polygon(r, [
        0,
        a.width,
        a.width,
        0
        ...
        Y,
        Y
      ], I, D), fill.translate(aa, d - Y + ga), s.push(fill));
      A += p / 2;
...
AmCharts.AmChart = AmCharts.Class({
  ...
  updateAnimations: function () {
    ...
    for (a = this.animations.length - 1; 0 <= a; a--) {
      var b = this.animations[a], c = 1000 * b.time / AmCharts.updateRate, d = b.frame + 1, e = b.obj, f = b.attribute;
      if (d <= c) {
        b.frame++;
...
AmCharts.AmGraph = AmCharts.Class({
  ...
  positionLabel: function (a, b, c, d, e, f) {
    ...
    case 'left':
      ...
      break;
    case 'inside':
      'column' == this.type && (lC = !0, isRotated ? isNegative ? (lA = 'end', a = e.x - 3 - this.labelOffset) : (lA = 'start', a = e.x + 3 + this.labelOffset) : b = isNegative ? e.y + 7 + this.labelOffset : e.y - 10 - this.labelOffset);
      break;
    case 'middle':
      'column' == this.type && (lC = !0, isRotated ? a -= (a - e.x) / 2 + this.labelOffset - 3 : b -= (b - e.y) / 2 + this.labelOffset - 3);
    }
  ...
  createSerialGraph: function () {
    ...
    isNaN(h) && (h = 0.8);
    var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate, r = this.columnCount, s = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), w = this.connect, v = [], t = [], u, x, F, B, z = this.chart.graphs.length, I, D = this.dx / this.tcc, H = this.dy / this.tcc, V = f.stackType, T = this.start, fa = this.end, aa = this.scrollbar, ga = this.categoryAxis, Na = this.baseCoord, ma = this.negativeBase, ba = this.columnIndex, Q = this.lineThickness, X = this.lineAlpha, na = this.lineColorR, $ = this.dashLength, W = this.set, Y, ja = this.getGradRotation(), G = this.chart.columnSpacing, A = ga.cellWidth, ka = (A * h - r) / r;
    G > ka && (G = ka);
    ...
    if ('line' == g || 'step' == g || 'smoothedLine' == g)
      if (this.stackable && 'regular' == V || '100%' == V || this.fillToGraph)
        Ea = !0;
    var Db = this.noStepRisers, $a = -1000, ab = -1000, bb = this.minDistance, Fa = !0, Qa = !1;
    for (J = T; J <= fa; J++) {
      S = d[J];
      ...
      if (l && void 0 == this.openField)
        for (var kb = J + 1; kb < d.length && (!d[kb] || !(Ra = d[J + 1].axes[f.id].graphs[b]) || !Ra.values || (Ga = Ra.values.value, isNaN(Ga))); kb++);
      var R, O, K, ca, ha = NaN, E = NaN, C = NaN, P = NaN, L = NaN, Ha = NaN, xa = NaN, Ia = NaN, ya = NaN, sa = NaN, ta = NaN, da = NaN, ea = NaN, U = NaN, lb = NaN, mb = NaN, ia = NaN, qa = void 0, Ca = jb, Ka = Oa, ua = na, oa, ra, nb = this.proCandlesticks, Sa = this.pattern;
      ...
      if (va) {
        ...
        ia = va.open;
        C = f.getCoordinate(U);
        isNaN(ia) || (L = f.getCoordinate(ia), l && (Ga = ia, ia = L = NaN));
        ...
        aa || (y.x = ha);
        -100000 > ha && (ha = -100000);
        ha > m + 100000 && (ha = m + 100000);
        q ? (E = C, P = L, L = C = ha, isNaN(ia) && !this.fillToGraph && (P = Na), Ha = xa, Ia = ya) : (P = E = ha, isNaN(ia) && !this.fillToGraph && (L = Na));
        if (!nb && U < ia || nb && U < Y)
        ...
        case 'line':
          if (isNaN(U))
            w || (this.drawLineGraph(v, t, M, N), v = [], t = [], M = [], N = []);
          else {
            if (Math.abs(E - $a) >= bb || Math.abs(C - ab) >= bb)
              v.push(E), t.push(C), $a = E, ab = C;
            sa = E;
            ta = C;
            da = E;
            ea = C;
            !Ea || isNaN(L) || isNaN(P) || (M.push(P), N.push(L));
            if (Qa || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength))
              this.drawLineGraph(v, t, M, N), v = [E], t = [C], M = [], N = [], !Ea || isNaN(L) || isNaN(P) || (M.push(P), N.push(L)), l ? Fa ? (this.lineColorSwitched = na, this.fillColorsSwitched = jb) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da) : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors), this.dashLengthSwitched = y.dashLength;
            y.gap && (this.drawLineGraph(v, t, M, N), v = [], t = [], M = [], N = []);
          }
          break;
        case 'smoothedLine':
          if (isNaN(U))
            w || (this.drawSmoothedGraph(v, t, M, N), v = [], t = [], M = [], N = []);
          else {
            if (Math.abs(E - $a) >= bb || Math.abs(C - ab) >= bb)
              v.push(E), t.push(C), $a = E, ab = C;
            sa = E;
            ...
            ea = C;
            !Ea || isNaN(L) || isNaN(P) || (M.push(P), N.push(L));
            void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawSmoothedGraph(v, t, M, N), v = [E], t = [C], M = [], N = [], !Ea || isNaN(L) || isNaN(P) || (M.push(P), N.push(L)), this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength);
            y.gap && (this.drawSmoothedGraph(v, t, M, N), v = [], t = [], M = [], N = []);
          }
          break;
        case 'step':
          if (!isNaN(U)) {
            if (void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawLineGraph(v, t, M, N), v = [], t = [], M = [], N = [], this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength), q ? (isNaN(u) || (v.push(u), t.push(C - la)), t.push(C - la), v.push(E), t.push(C + za), v.push(E), !Ea || isNaN(L) || isNaN(P) || (M.push(F), N.push(L - la), M.push(P), N.push(L - la), M.push(P), N.push(L + za))) : (isNaN(x) || (t.push(x), v.push(u), t.push(x), v.push(E - la)), v.push(E - la), t.push(C), v.push(E + za), t.push(C), !Ea || isNaN(L) || isNaN(P) || (M.push(P - la), N.push(B), M.push(P - la), N.push(L), M.push(P + za), N.push(L))), u = E, x = C, F = P, B = L, sa = E, ta = C, da = E, ea = C, Qa && (this.drawLineGraph(v, t, M, N), v = [], t = [], M = [], N = [], l && (Fa ? (this.lineColorSwitched = na, this.fillColorsSwitched = jb) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da))), Db || y.gap)
              u = x = NaN, this.drawLineGraph(v, t, M, N), v = [], t = [], M = [], N = [];
          } else if (!w) {
            if (1 >= this.periodSpan || 1 < this.periodSpan && E - u > la + za)
              u = x = NaN;
            this.drawLineGraph(v, t, M, N);
            v = [];
            t = [];
            M = [];
            N = [];
        ...
        case 'column':
          ...
          if (!isNaN(U)) {
            ...
            if (!(U < Fb && ia < Fb || U > Gb && ia > Gb)) {
              var pa;
              if (q) {
                '3d' == V ? (O = C - (r / 2 - this.depthCount + 1) * (h + G) + G / 2 + H * ba, R = P + D * ba, pa = ba) : (O = Math.floor(C - (r / 2 - ba) * (h + G) + G / 2), R = P, pa = 0);
                K = h;
                sa = E;
                ta = O + h / 2;
                da = E;
                ea = O + h / 2;
                O + K > n + pa * H && (K = n - O + pa * H);
                O < pa * H && (K += O, O = pa * H);
                ca = E - P;
                var Qb = R;
                R = AmCharts.fitToBounds(R, 0, m);
                ca += Qb - R;
                ca = AmCharts.fitToBounds(ca, -R, m - R + D * ba);
                O < n && 0 < K && (qa = new AmCharts.Cuboid(e, ca, K, D - a.d3x, H - a.d3y, Ca, Ka, Q, oa, X, ja, s, q, $, Sa, Eb), y.columnWidth = Math.abs(ca), y.columnHeight = Math.abs(K));
              } else {
                '3d' == V ? (R = E - (r / 2 - this.depthCount + 1) * (h + G) + G / 2 + D * ba, O = L + H * ba, pa = ba) : (R = E - (r / 2 - ba) * (h + G) + G / 2, O = L, pa = 0);
                K = h;
                sa = R + h / 2;
                ta = C;
                da = R + h / 2;
                ea = C;
                R + K > m + pa * D && (K = m - R + pa * D);
                R < pa * D && (K += R - pa * D, R = pa * D);
                ca = C - L;
                var Rb = O;
                O = AmCharts.fitToBounds(O, this.dy, n);
                ca += Rb - O;
                ca = AmCharts.fitToBounds(ca, -O + H * ba, n - O);
                R < m + ba * D && 0 < K && (this.showOnAxis && (O -= H / 2), qa = new AmCharts.Cuboid(e, K, ca, D - a.d3x, H - a.d3y, Ca, Ka, Q, oa, this.lineAlpha, ja, s, q, $, Sa, Eb), y.columnHeight = Math.abs(ca), y.columnWidth = Math.abs(K));
              }
            }
            if (qa && (ra = qa.set, y.columnGraphics = ra, ra.translate(R, O), this.columnsSet.push(ra), (y.url || this.showHandOnHover) && ra.setAttr('cursor', 'pointer'), !aa)) {
              'none' == V && (I = q ? (this.end + 1 - J) * z - c : z * J + c);
              '3d' == V && (q ? (I = (this.end + 1 - J) * z - c - 1000 * this.depthCount, sa += D * this.columnIndex, da += D * this.columnIndex, y.y += D * this.columnIndex) : (I = (z - c) * (J + 1) + 1000 * this.depthCount, ta += H * this.columnIndex, ea += H * this.columnIndex, y.y += H * this.columnIndex));
              if ('regular' == V || '100%' == V)
              ...
              this.animateColumns(qa, J, E, P, C, L);
        ...
        case 'candlestick':
          if (!isNaN(ia) && !isNaN(U)) {
            ...
            void 0 != y.lineColor && (oa = y.lineColor);
            if (q) {
              if (O = C - h / 2, R = P, K = h, O + K > n && (K = n - O), 0 > O && (K += O, O = 0), O < n && 0 < K) {
                var qb, rb;
                U > ia ? (qb = [
                  E,
                  Ia
                ...
                !isNaN(Ia) && !isNaN(Ha) && C < n && 0 < C && (db = AmCharts.line(e, qb, [
                  C,
                  C
                ], oa, X, Q), pb = AmCharts.line(e, rb, [
                  C,
                  C
                ], oa, X, Q));
                ca = E - P;
                qa = new AmCharts.Cuboid(e, ca, K, D, H, Ca, Oa, Q, oa, X, ja, s, q, $, Sa);
              }
            } else if (R = E - h / 2, O = L + Q / 2, K = h, R + K > m && (K = m - R), 0 > R && (K += R, R = 0), ca = C - L, R < m && 0 < K) {
              nb && U >= ia && (Ka = 0);
              var qa = new AmCharts.Cuboid(e, K, ca, D, H, Ca, Ka, Q, oa, X, ja, s, q, $, Sa), sb, tb;
              U > ia ? (sb = [
                C,
                ya
              ], tb = [
              ...
              !isNaN(ya) && !isNaN(xa) && E < m && 0 < E && (db = AmCharts.line(e, [
                E,
                E
              ], sb, oa, X, Q), pb = AmCharts.line(e, [
                E,
                E
              ], tb, oa, X, Q));
            }
            qa && (ra = qa.set, y.columnGraphics = ra, W.push(ra), ra.translate(R, O - Q / 2), (y.url || this.showHandOnHover) && ra.setAttr('cursor', 'pointer'), db && (W.push(db), W.push(pb)), sa = E, ta = C, q ? (ea = C, da = E, 'open' == k && (da = P), 'high' == k && (da = Ia), 'low' == k && (da = Ha)) : (ea = C, 'open' == k && (ea = L), 'high' == k && (ea = ya), 'low' == k && (ea = xa), da = E), aa || (y.x = q ? O + K / 2 : R + K / 2, this.animateColumns(qa, J, E, P, C, L), this.addListeners(ra, y)));
          }
          break;
        case 'ohlc':
          if (!(isNaN(ia) || isNaN(lb) || isNaN(mb) || isNaN(U))) {
            ...
            if (q) {
              ...
              var zb = E - h / 2, zb = AmCharts.fitToBounds(zb, 0, m), Ib = AmCharts.fitToBounds(E, 0, m), Ab = E + h / 2, Ab = AmCharts.fitToBounds(Ab, 0, m);
              vb = AmCharts.line(e, [
                zb,
                Ib
              ], [
        ...
        if (!aa && !isNaN(U)) {
          ...
          if (this.end - this.start <= Jb || 0 === Jb) {
            ...
            if (Kb) {
              ...
              (Bb = this.positionLabel(sa, ta, Bb, Sb, K, ca)) && this.allBullets.push(Bb);
            }
            if ('regular' == V || '100%' == V) {
              var Lb = f.totalText;
              if (Lb) {
                ...
                q ? (Ua = C, Ta = 0 > U ? E - Nb / 2 - 2 - Va : E + Nb / 2 + 3 + Va) : (Ta = E, Ua = 0 > U ? C + Ob / 2 + Va : C - Ob / 2 - 3 - Va);
                Ma.translate(Ta, Ua);
                f.totals[J] = Ma;
    ...
    if ('line' == g || 'step' == g || 'smoothedLine' == g)
      'smoothedLine' == g ? this.drawSmoothedGraph(v, t, M, N) : this.drawLineGraph(v, t, M, N), aa || this.launchAnimation();
  ...
  drawLineGraph: function (a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      if (0 < f || 0 < t)
        if (n = a.join(';').split(';'), q = b.join(';').split(';'), m = g.type, 'serial' == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0])) : (n.push(n[n.length - 1]), q.push(u), n.push(n[0]), q.push(u), n.push(a[0]), q.push(q[0])) : 'xy' == m && (b = e.fillToAxis) && (AmCharts.isString(b) && (b = g.getValueAxisById(b)), 'H' == b.orientation ? (u = 'top' == b.position ? 0 : b.viH, n.push(n[n.length - 1]), q.push(u), n.push(n[0]), q.push(u), n.push(a[0]), q.push(q[0])) : (u = 'left' == b.position ? 0 : b.viW, q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (g = AmCharts.polygon(h, n, q, r, f, 1, '#000', 0, a), g.pattern(e.pattern), k.push(g)), v || void 0 !== s)
          isNaN(t) && (t = f), v || (v = s), h = AmCharts.polygon(h, n, q, v, t, 1, '#000', 0, a), h.pattern(e.pattern), l.push(h), l.click(function (a) {
            e.handleGraphEvent(a, 'clickGraph');
          }).mouseover(function (a) {
            e.handleGraphEvent(a, 'rollOverGraph');
          }).mouseout(function (a) {
...
AmCharts.ChartCursor = AmCharts.Class({
  ...
  createCrosshair: function () {
    var a = this.cursorAlpha, b = this.container, c = AmCharts.line(b, [
        ...
        0,
        this.height
      ], this.cursorColor, a, 1), a = AmCharts.line(b, [
        0,
        this.width
      ], [
        0,
      ...
      if (q) {
        ...
        if (c.mouseIsOver || F || B || this.forceShow)
          if (this.forceShow = !1, B) {
            var h = this.panClickPos, c = this.panClickEndTime, F = this.panClickStartTime, I = this.panClickEnd, l = this.panClickStart, e = (s ? h - f : h - e) / w;
            ...
            if (0 < this.cursorAlpha) {
              ...
              0 < w && !this.zooming ? isNaN(this.previousX) ? D.translate(t, u) : (D.translate(this.previousX, this.previousY), D.animate({ translate: t + ',' + u }, w, 'easeOutSine')) : D.translate(t, u);
              this.previousX = t;
              this.previousY = u;
              D.show();
            }
            this.linePos = s ? r + k : r;
            F && (d && D.hide(), s ? this.updateSelectionSize(NaN, r) : this.updateSelectionSize(r, NaN));
            w = !0;
            F && (w = !1);
            ...
            if (this.oneBalloonOnly) {
              ...
              for (g = 0; g < z.length; g++)
                t = z[g], t.showBalloon && !t.hidden && t.balloonText && (u = q.axes[t.valueAxis.id].graphs[t.id], v = u.y, isNaN(v) || (s ? Math.abs(e - v) < r && (r = Math.abs(e - v), I = t) : Math.abs(f - v) < r && (r = Math.abs(f - v), I = t)));
              ...
              if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                ...
                for (g = 0; g < z.length; g++)
                  if (t = z[g], v = NaN, (!this.oneBalloonOnly || t == I) && t.showBalloon && !t.hidden && t.balloonText && ('step' == t.type && 'left' == t.stepDirection && (q = this.data[a + 1]), q)) {
                    if (u = q.axes[t.valueAxis.id].graphs[t.id])
                      v = u.y;
                    if (this.showNextAvailable && isNaN(v) && a + 1 < this.data.length)
                      for (r = a + 1; r < this.data.length; r++)
                        if (d = this.data[r])
                          if (u = d.axes[t.valueAxis.id].graphs[t.id], v = u.y, !isNaN(v))
                            break;
                    if (!isNaN(v)) {
                      d = u.x;
                      k = !0;
                      if (s) {
                        ...
                        k = !1;
                      k && (k = this.graphBulletSize, D = this.graphBulletAlpha, 1 == k && isNaN(D) || !AmCharts.isModern || !(x = u.bulletGraphics) || (x.getBBox(), x.translate(u.bx, u.by, k), this.resizedBullets.push(u), isNaN(D) || (x.setAttr('fill-opacity', D), x.setAttr('stroke-opacity', D))), k = t.valueBalloon, D = c.getBalloonColor(t, u), k.setBounds(l, m, l + n, m + p), k.pointerOrientation = 'H', x = this.balloonPointerOrientation, 'vertical' == x && (k.pointerOrientation = 'V'), 'horizontal' == x && (k.pointerOrientation = 'H'), k.changeColor(D), void 0 !== t.balloonAlpha && (k.fillAlpha = t.balloonAlpha), void 0 !== t.balloonTextColor && (k.color = t.balloonTextColor), k.setPosition(r + l, d + m), r = c.formatString(t.balloonText, u, !0), (d = t.balloonFunction) && (r = d(u, t).toString()), '' !== r && (s ? k.showBalloon(r) : (k.text = r, k.show = !0), w.push({
                        yy: v,
                        balloon: k
    ...
    if (this.skipEvent)
      ...
      if (h.parseDates && !h.equalSpacing) {
        if (a = g.lastTime, g = g.firstTime, h.minDuration(), h = Math.round(b / k) + g, b = this.dragging ? h + this.timeDifference : Math.round((b + c) / k) + g, h > b && (h = b), 0 < e && b - h < e && (b = Math.round(h + (b - h) / 2), d = Math.round(e / 2), h = b - d, b += d, d = !0), b > a && (b = a), b - e < h && (h = b - e), h < g && (h = g), h + e > b && (b = h + e), h != this.startTime || b != this.endTime)
          this.startTime = h, this.endTime = b, f.start = h, f.end = b, f.startDate = new Date(h), f.endDate = new Date(b), this.fire(f.type, f);
  ...
  draw: function () {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        B < g && (B = g);
        B + z > k && (B = k - z);
        var h = x + s, l = B + r, s = this.shadowAlpha, D = this.shadowColor, r = this.borderThickness, H = this.bulletSize, V;
        0 < t || 0 === w ? (0 < s && (a = AmCharts.rect(e, z, u, n, 0, r + 1, D, s, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, z, u, n, this.fillAlpha, r, p, this.borderAlpha, this.cornerRadius), this.showBullet && (V = AmCharts.circle(e, H, q, this.fillAlpha), f.push(V))) : (q = [], t = [], 'H' != v ? (g = a - B, g > z - w && (g = z - w), g < w && (g = w), q = [
          0,
          g - w,
          a - B,
          g + w,
          ...
          0,
          z
        ]), 0 < s && (a = AmCharts.polygon(e, q, t, n, 0, r, D, s), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, t, n, this.fillAlpha, r, p, this.borderAlpha));
        this.bg = n;
        f.push(n);
        n.toFront();
        e = 1 * this.deltaSignX;
  ...
  parseSerialData: function () {
    ...
    if (e) {
      ...
      for (s = 0; s < e.length; s++) {
        ...
        l && (t.labelColor = u[l]);
        r[u[d]] = t;
        if (f && (b = h.categoryFunction ? h.categoryFunction(b, u, h) : b instanceof Date ? AmCharts.newDate(b, h.minPeriod) : w ? AmCharts.stringToDate(b, w) : new Date(b), b = AmCharts.resetDateToMin(b, m, n, h.firstDayOfWeek), t.category = b, t.time = b.getTime(), isNaN(t.time)))
          continue;
        ...
        for (F = 0; F < x.length; F++) {
          ...
          for (z = 0; z < a.length; z++) {
            ...
            if (b.valueAxis.id == B) {
              ...
              var V = u;
              b.dataProvider && (V = c);
              H.values = this.processValues(V, b, D);
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function () {
    var a = this;
    a.destroy();
    var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, q = a.valueAxisX, r = a.initialXValue, s = a.finalXValue, w = a.initialValue, v = a.finalValue, t = p.recalculateToPercents, u = b.dataDateFormat;
    ...
    isNaN(d) || isNaN(e) || isNaN(f) || isNaN(f) || (b.rotate ? (h = [
      ...
      f,
      g
    ]), f = a.lineColor, d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength), g = h, k = e, n = h[1] - h[0], p = e[1] - e[0], 0 === n && (n = 0.01), 0 === p && (p = 0.01), l = n / Math.abs(n), m = p / Math.abs(p), p = n * p / Math.abs(n * p) * Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2)), n = Math.asin(n / p), p = 90 * Math.PI / 180 - n, n = Math.abs(5 * Math.cos(p)), p = Math.abs(5 * Math.sin(p)), g.push(h[1] - l * p, h[0] - l * p), k.push(e[1] + m * n, e[0] + m * n), h = AmCharts.polygon(c, g, k, f, 0.005, 0), c = c.set([
      h,
      d
    ]), c.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet.push(c), a.line = d, a.set = c, h.mouseup(function () {
      a.handleLineClick();
    }).mouseover(function () {
      a.handleLineOver();
    }).mouseout(function () {
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
  ...
  for (m = 1; m < b.length; m++)
    for (var p = [
          ...
          c[m - 1],
          c[m]
        ], q = AmCharts.makeHD(p, q, a.handDrawScatter), p = q[0], q = q[1], r = 1; r < p.length; r++)
      n.push(AmCharts.line(a, [
        p[r - 1],
        p[r]
      ], [
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
  ...
  d = a.set();
  var D;
  r && (s = p(10 * s), t = p(10 * t), x = p(10 * x), B = p(10 * B), v = p(10 * v), u = p(10 * u), F = p(10 * F), w = p(10 * w), b = p(10 * b), k = p(10 * k), c = p(10 * c), f *= 10, g *= 10, h *= 10, q *= 10, 1 > Math.abs(e) && 1 >= Math.abs(x - t) && 1 >= Math.abs(F - u) && (D = !0));
  e = '';
  var H;
  n && (z['fill-opacity'] = 0, z['stroke-opacity'] = l['stroke-opacity'] / 2, z.stroke = l.stroke);
  0 < k && (H = ' M' + s + ',' + (v + k) + ' L' + t + ',' + (u + k), r ? (D || (H += ' A' + (b - f) + ',' + (k + c - g) + ',' + (b + f) + ',' + (k + c + g) + ',' + t + ',' + (u + k) + ',' + x + ',' + (F + k)), H += ' L' + B + ',' + (w + k), 0 < h && (D || (H += ' B' + (b - h) + ',' + (k + c - q) + ',' + (b + h) + ',' + (k + c + q) + ',' + B + ',' + (k + w) + ',' + s + ',' + (k + v)))) : (H += ' A' + f + ',' + g + ',0,' + I + ',1,' + x + ',' + (F + k) + ' L' + B + ',' + (w + k), 0 < h && (H += ' A' + h + ',' + q + ',0,' + I + ',0,' + s + ',' + (v + k))), H = a.path(H + ' Z', void 0, void 0, '1000,1000').attr(z), d.push(H), H = a.path(' M' + s + ',' + v + ' L' + s + ',' + (v + k) + ' L' + t + ',' + (u + k) + ' L' + t + ',' + u + ' L' + s + ',' + v + ' Z', void 0, void 0, '1000,1000').attr(z), k = a.path(' M' + x + ',' + F + ' L' + x + ',' + (F + k) + ' L' + B + ',' + (w + k) + ' L' + B + ',' + w + ' L' + x + ',' + F + ' Z', void 0, void 0, '1000,1000').attr(z), d.push(H), d.push(k));
  r ? (D || (e = ' A' + p(b - f) + ',' + p(c - g) + ',' + p(b + f) + ',' + p(c + g) + ',' + p(t) + ',' + p(u) + ',' + p(x) + ',' + p(F)), f = ' M' + p(s) + ',' + p(v) + ' L' + p(t) + ',' + p(u) + e + ' L' + p(B) + ',' + p(w)) : f = ' M' + s + ',' + v + ' L' + t + ',' + u + (' A' + f + ',' + g + ',0,' + I + ',1,' + x + ',' + F) + ' L' + B + ',' + w;
  0 < h && (r ? D || (f += ' B' + (b - h) + ',' + (c - q) + ',' + (b + h) + ',' + (c + q) + ',' + B + ',' + w + ',' + s + ',' + v) : f += ' A' + h + ',' + q + ',0,' + I + ',0,' + s + ',' + v);
...
AmCharts.SVGRenderer = AmCharts.Class({
  ...
  update: function () {
    ...
    for (a = b.length - 1; 0 <= a; a--) {
      var c = b[a], d = 1000 * c.time / AmCharts.updateRate, e = c.frame + 1, f = c.obj, g = c.attribute, h, k, l;
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  drawLegend: function () {
    ...
    this.titleWidth = 0;
    if (e = this.title)
      a = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, 'start', !0), a.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = a.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
  ...
  arrangeEntries: function () {
    ...
    for (u = 0; u < v.length; u++) {
      ...
      t = I.getBBox();
      var D;
      this.equalWidths ? D = f + x * (p + m + this.markerLabelGap) : (D = F, F = F + t.width + f + m);
      t.height > z && (z = t.height);
      D + t.width > n && 0 < u && 0 !== x && (q++, x = 0, D = f, F = D + t.width + f + m, B = B + z + l, z = 0);
      I.translate(D, B);
      x++;
    ...
    if ('top' == a || 'bottom' == a || 'absolute' == a || 'outside' == a)
      'center' == this.align ? b = f + (h - t.width) / 2 : 'right' == this.align && (b = f + h - t.width);
    w.translate(b, l + 1);
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      if (this.useGraphSettings)
        if (m = a.type, this.switchType = void 0, 'line' == m || 'step' == m || 'smoothedLine' == m || 'ohlc' == m)
          g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), n = AmCharts.line(k, [
            0,
            2 * l
          ], [
            l / 2,
            l / 2
          ], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden || (d = a.bulletColorR), n = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2), g.push(n)), p = 0, m = l, n = l / 3;
        else {
          var q;
  ...
  createX: function () {
    var a = (this.markerSize - 4) / 2, b = {
        ...
        'stroke-width': 3
      }, c = this.container, d = AmCharts.line(c, [
        -a,
        a
      ], [
        -a,
        a
      ]).attr(b), a = AmCharts.line(c, [
        -a,
        a
      ], [
        a,
...
AmCharts.AmSerialChart = AmCharts.Class({
  ...
  countColumns: function () {
    ...
    for (h = 0; h < b; h++) {
      ...
      if ('100%' == g || 'regular' == g)
        for (f = !1, l = 0; l < c; l++)
          d = this.graphs[l], d.tcc = 1, d.valueAxis == e && 'column' == d.type && (!f && d.stackable && (a++, f = !0), (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
      if ('none' == g || '3d' == g) {
        f = !1;
        for (l = 0; l < c; l++)
          d = this.graphs[l], d.valueAxis == e && 'column' == d.type && (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) : d.hidden || (f = !0, d.tcc = 1, d.columnIndex = 0));
        f && 0 == a && (a = 1);
      }
      if ('3d' == g) {
        e = 1;
  ...
  formatPeriodString: function (a, b) {
    if (b) {
      var c = [
          ...
          'high',
          'close'
        ], d = 'value open low high close average sum count'.split(' '), e = b.valueAxis, f = this.chartData, l = b.numberFormatter;
      l || (l = this.nf);
...
AmCharts.Cuboid = AmCharts.Class({
  ...
  draw: function () {
    var a = this.set;
    a.clear();
    var b = this.container, c = this.w, d = this.h, e = this.dx, f = this.dy, l = this.colors, h = this.alpha, g = this.bwidth, k = this.bcolor, m = this.balpha, p = this.gradientRotation, v = this.cornerRadius, r = this.dashLength, s = this.pattern, n = this.topRadius, w = l, q = l;
    ...
    if (0 < Math.abs(e) || 0 < Math.abs(f))
      if (isNaN(n))
        u = q, q = AmCharts.adjustLuminosity(w, -0.2), q = AmCharts.adjustLuminosity(w, -0.2), x = AmCharts.polygon(b, [
          0,
          e,
          c + e,
          c,
          ...
          0,
          0
        ], q, h, 1, k, 0, p), 0 < m && (H = AmCharts.line(b, [
          0,
          e,
          c + e
        ], [
          ...
          0,
          0
        ], q, h, 1, k, 0, p), t.translate(e, f), 0 < m && (z = AmCharts.line(b, [
          e,
          e
        ], [
          f,
          f + d
        ], k, m, g, r)), y = AmCharts.polygon(b, [
          0,
          0,
          e,
          e,
          ...
          f,
          0
        ], q, h, 1, k, 0, p), B = AmCharts.polygon(b, [
          c,
          c,
          c + e,
          c + e,
          ...
          f,
          0
        ], q, h, 1, k, 0, p), 0 < m && (D = AmCharts.line(b, [
          c,
          c + e,
          c + e,
          c
          ...
          d + f,
          d
        ], k, m, g, r)), q = AmCharts.adjustLuminosity(u, 0.2), u = AmCharts.polygon(b, [
          0,
          e,
          c + e,
          c,
          ...
          d,
          d
        ], q, h, 1, k, 0, p), 0 < m && (A = AmCharts.line(b, [
          0,
          e,
          c + e
        ], [
        ...
        F = C * n;
        G = E * n;
        0.1 < C && 0.1 < C && (x = AmCharts.circle(b, C, w, h, g, k, m, !1, E), x.translate(q, J));
        0.1 < F && 0.1 < F && (u = AmCharts.circle(b, F, AmCharts.adjustLuminosity(w, 0.5), h, g, k, m, !1, G), u.translate(K, L));
      }
    h = M;
    1 > Math.abs(d) && (d = 0);
    1 > Math.abs(c) && (c = 0);
    !isNaN(n) && (0 < Math.abs(e) || 0 < Math.abs(f)) ? (l = [w], l = {
      ...
      w,
      AmCharts.adjustLuminosity(w, -0.3),
      AmCharts.adjustLuminosity(w, -0.3),
      w
    ], C), I ? b.translate(e / 2, 0) : b.translate(0, f / 2)) : b = 0 === d ? AmCharts.line(b, [
      0,
      c
    ], [
      0,
      0
    ], k, m, g, r) : 0 === c ? AmCharts.line(b, [
      0,
      0
    ], [
      0,
      d
    ], k, m, g, r) : 0 < v ? AmCharts.rect(b, c, d, l, h, g, k, m, v, p, r) : AmCharts.polygon(b, [
      0,
      0,
      c,
      c,
  ...
  animateHeight: function (a, b) {
    var c = this;
    c.easing = b;
    c.totalFrames = Math.round(1000 * a / AmCharts.updateRate);
    c.rh = c.h;
    c.frame = 0;
    c.height(1);
    setTimeout(function () {
...
AmCharts.CategoryAxis = AmCharts.Class({
  ...
  draw: function () {
    ...
    if (AmCharts.ifArray(a)) {
      ...
      var v, r, s, n, w, q;
      v = this.rotate;
      var x = this.firstDayOfWeek, t = this.boldPeriodBeginning, a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * k), this.minPeriod, 1, x).getTime(), z;
      ...
      if (this.parseDates && !this.equalSpacing) {
        ...
        if (0 < this.gridCountR)
          for (b = d; b <= l; b++) {
            ...
            'MM' == e && (q = (p - m) / r, 1.5 <= (p - m) / r && (p = p - (q - 1) * r + AmCharts.getPeriodDuration('DD', 3), p = AmCharts.resetDateToMin(new Date(p), e, 1).getTime(), A += r));
            ...
            if (!isNaN(y))
              for (k = 1; k < v; k += y)
                this.gridAlpha = this.minorGridAlpha, q = p + B * k, q = AmCharts.resetDateToMin(new Date(q), e, y, x).getTime(), q = new this.axisItemRenderer(this, (q - this.startTime) * this.stepWidth), this.pushAxisItem(q);
            this.gridAlpha = a;
          }
      } else if (!this.parseDates) {
        if (this.cellWidth = this.getStepWidth(b), b < l && (l = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < l)
          for (t = Math.floor(b / l), y = this.chooseMinorFrequency(t), k = f, k / 2 == Math.round(k / 2) && k--, 0 > k && (k = 0), l = 0, this.end - k + 1 >= this.autoRotateCount && (this.labelRotation = this.autoRotateAngle), b = k; b <= this.end + 2; b++) {
            n = !1;
            0 <= b && b < this.data.length ? (s = this.data[b], m = s.category, n = s.forceShow) : m = '';
            if (q && !isNaN(y))
              if (b / y == Math.round(b / y) || n)
                b / t == Math.round(b / t) || n || (this.gridAlpha = this.minorGridAlpha, m = void 0);
              else
                continue;
            else if (b / t != Math.round(b / t) && !n)
              continue;
        ...
        if (this.data[k].time != AmCharts.resetDateToMin(new Date(this.data[k].time), e, v, x).getTime())
          for (x = 0, z = m, b = k; b < w; b++)
            p = this.data[b].time, this.checkPeriodChange(e, v, p, z) && (x++, 2 <= x && (r = b, b = w), z = p);
        q && 1 < v && (y = this.chooseMinorFrequency(v), AmCharts.getPeriodDuration(e, y));
        if (0 < this.gridCountR)
          for (b = k; b < w; b++)
            if (p = this.data[b].time, this.checkPeriodChange(e, v, p, m) && b >= r) {
...
app.constant('ENDPOINT', { 'URL': 'https://rubricamobilevirtual.appspot.com/api/' });
'use strict';
/*global app:true*/
app.controller('IndexCtrl', [
  ...
  '$modal',
  'ENDPOINT',
  function ($scope, $http, $routeParams, $modal, ENDPOINT) {
    $scope.current_course = $routeParams.course;
    $scope.assignmentsRequest = $http({
      method: 'GET',
      url: ENDPOINT.URL + 'assignments?course=' + $scope.current_course
    ...
    $scope.showRubric = function (rubric_settings, rubric) {
      var modal = $modal({
          title: rubric_settings.title,
          show: false,
          contentTemplate: '/views/modal_templates/rubric_template.html'
        });
...
app.controller('ActivityCtrl', [
  ...
  '$modal',
  'ENDPOINT',
  function ($scope, $http, $routeParams, $q, $location, $rootScope, $modal, ENDPOINT) {
    ...
    $scope.changeSection = function (section) {
      ...
      $scope.submissionsRequest = $http({
        method: 'GET',
        url: ENDPOINT.URL + 'assignments/' + $scope.current_course + '/' + $routeParams.assignment + '/submissions?section=' + section
      }).success(function (data, status, headers, config) {
    ...
    var assignmentDetails = $http({
        method: 'GET',
        url: ENDPOINT.URL + 'assignments/' + $scope.current_course + '/' + $scope.assignment
      }).success(function (data, status, headers, config) {
        $scope.assignment = data;  // console.log($scope.assignment);
      }).error(function (data, status, headers, config) {
      });
    $scope.submissionsRequest = $http({
      method: 'GET',
      url: ENDPOINT.URL + 'assignments/' + $scope.current_course + '/' + $scope.assignment + '/submissions'
    }).success(function (data, status, headers, config) {
      $scope.submissions = data;
    }).error(function (data, status, headers, config) {
    });
    $http({
      method: 'GET',
      url: ENDPOINT.URL + 'students/' + $scope.current_course
    }).success(function (data, status, headers, config) {
    ...
    $http({
      method: 'GET',
      url: ENDPOINT.URL + 'sections/' + $scope.current_course
    }).success(function (data, status, headers, config) {
      $scope.sections = data;
    }).error(function (data, status, headers, config) {
    });
    $scope.handleClick = function (i) {
      return function (event) {
        $scope.activeStudents = $.grep($scope.courseStudents, function (e) {
          console.log(e.id);
          return $scope.submissions[i][event.index].students.indexOf(e.id) > -1;
        });
        $modal({
          title: 'Alunos',
          scope: $scope,
          template: '/views/modal_templates/student_names.html',
          show: true
        });
      };
    };
    $q.all([
      $scope.submissionsRequest,
      assignmentDetails
      ...
      $scope.toolTipHelper = function (index, graph) {
        return function (graphDataItem) {
          var item = $.grep($scope.assignment.rubric[index].ratings, function (e) {
              return e.points === graphDataItem.dataContext.rating;
            });
